...
The manuscript was compiled with Typst 0.15.1 using `typst compile manuscript.typ manuscript.pdf` in `work/`, then all four rendered pages were visually inspected after the final editorial edit. The title, theorem, equations, tables, citations and reproduction appendix rendered legibly without clipping. No formal verification was requested. Target-solver scale beyond eight source items was not measured. During research, no remote, publication or board change was made. Public archiving was separately authorized after campaign closeout.

Experience extraction: 0 entries created, 0 updated, 0 pending. Round 001 found no qualifying generalizable failure record beyond its candidate-specific proof and oracle execution repair. Research model: `gpt-6-sol`, confirmed from the original Codex session metadata rather than inferred from a later default. Public archive: https://github.com/reduction-zoo/partition-deadlines-setup-times. Next action: human expert review of the proof and literature relationship.
